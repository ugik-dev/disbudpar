  ...
  <div class="ibox ssection-container">
    <div class="ibox-content">
      <form class="form-inline" id="toolbar_form" onsubmit="return false;">
        ...
        <button hidden htype="submit" class="btn btn-primary my-1 mr-sm-2" id="add_btn"  data-loading-text="Loading..." onclick="this.form.target='add'"><i class="fal fa-plus"></i> Tambah</button>
    ...
    <div class="modal-content animated fadeIn">
      ...
      <div class="modal-body" id="modal-body">              
        <form role="form" id="user_form" onsubmit="return false;" type="multipart" autocomplete="off">
          ...
          <div class="form-group">
            <label for="id_j_senibudaya">Kabupaten / Kota</label> 
...
$(document).ready(function() {
  ...
  var SenibudayaModal = {
    ...
    'kabupaten': $('#senibudaya_modal').find('#kabupaten'),
  }
  ...
  function renderKabupatenSelection(data){
    SenibudayaModal.kabupaten.empty();
    SenibudayaModal.kabupaten.append($('<option>', { value: "", text: "-- Pilih Kabupaten --"}));
    Object.values(data).forEach((d) => {
      SenibudayaModal.kabupaten.append($('<option>', {
  ...
  function renderSenibudaya(data){
    ...
    Object.values(data).forEach((senibudaya) => {
      ...
      var detailButton =`
      <a class="detail dropdown-item" href='<?=site_url()?>AdminController/DetailSenibudaya?id_senibudaya=${senibudaya['id_senibudaya']}'><i class='fa fa-share'></i> Detail Seni Budaya</a>
      `; 
      var editButton = `
      ...
      `;
      renderData.push([ senibudaya['nama'],senibudaya['nama_kabupaten'], senibudaya['nama_j_senibudaya'], senibudaya['nama_j2_senibudaya'],senibudaya['tahun_terdata'],apprv, button]);
    });
    FDataTable.clear().rows.add(renderData).draw('full-hold');
  }

  document.getElementById("export_btn").href = '<?= site_url('AdminController/PdfAllSenibudaya')?>';
  ...
  FDataTable.on('click','.edit', function(){
    ...
    SenibudayaModal.kabupaten.val(senibudaya['id_kabupaten']);
  });
