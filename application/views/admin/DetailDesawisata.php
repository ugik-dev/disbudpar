                        ...
                        <div class="ibox">
                            ...
                            <div id="profil">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="namadesawisata"  readonly="readonly">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-row">
                                    ...
                                    <label for="formGroupExampleInput">Kategori Desa Wisata</label>
                                ...
                                <button class="btn btn-success my-1 mr-sm-2" type="submit" id="edit_profil_btn" onclick="myFunction()" data-loading-text="Loading..."><strong>Ubah Data Desa Wisata</strong></button>
                                <button class="btn btn-info my-1 mr-sm-2" type="submit" id="approv_profil_btn" onclick="ApprovProfil()" data-loading-text="Loading..."><strong>Approv Profil Desa Wisata</strong></button>
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group" style="width : 60%;">
                                            ...
                                            <input type="text" class="form-control" id="id_desawisatatoupload1" name="id_desawisata" hidden>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group" style="width : 60%;">
                                            ...
                                            <input type="text" class="form-control" id="id_desawisatatoupload2" name="id_desawisata" hidden >
                                ...
                                <div class="form-row">
                                    <form class="form-row col-md-12" id="form_uploaddokumen" onsubmit="return false;">
                                        ...
                                        <div class="form-group" style="width : 60%;">
                                                <input type="text" class="form-control" id="id_desawisatatoupload4" name="id_desawisata" hidden>
    ...
    <div class="modal-content animated fadeIn">
      ...
      <div class="modal-body" id="modal-body">              
        <form role="form" id="user_form" onsubmit="return false;" type="multipart" autocomplete="off">
          <input type="text" id="edit_id_desawisata" name="id_desawisata" hidden>
          <div class="form-group">
            <label for="nama">Nama Desa Wisata</label> 
            <input type="text" placeholder="Nama Desawisata" class="form-control" id="edit_nama" name="nama" required="required">
          </div>
          <div class="form-group">
...
$(document).ready(function() {
  ...
  var id_desawisata = "<?=$contentData['id_desawisata']?>";
  console.log(id_desawisata);
  var dataProfil;
  var dataTahun
...
$('#form_upload1').submit(function(e){
  console.log('file1upload')
            e.preventDefault(); 
                 $.ajax({
                     url:`<?=site_url('DetailDesawisataController/do_upload')?>`,
                     type:"post",
...
$('#form_upload2').submit(function(e){
  ...
  e.preventDefault(); 
                 $.ajax({
                     url:`<?=site_url('DetailDesawisataController/do_upload2')?>`,
                     type:"post",
                     data:new FormData(this),
                     processData:false,
                     contentType:false,
...
$('#form_upload3').submit(function(e){
  ...
  e.preventDefault(); 
                 $.ajax({
                     url:`<?=site_url('DetailDesawisataController/do_upload3')?>`,
                     type:"post",
                     data:new FormData(this),
                     processData:false,
                     contentType:false,
...
$('#form_uploaddokumen').submit(function(e){
  ...
  e.preventDefault(); 
                 $.ajax({
                     url:`<?=site_url('DetailDesawisataController/do_upload4')?>`,
                     type:"post",
                     data:new FormData(this),
                     processData:false,
                     contentType:false,
...
//======
  ...
  var toolbar = {
    'form': $('#toolbar_form'),
    'id_desawisata': $('#id_desawisata2'),
    'showBtn': $('#show_btn'),
  }
  toolbar.id_desawisata.val(id_desawisata);
  console.log('idcgar',id_desawisata)
  ...
  var InputModal = {
    ...
    'id_desawisata': $('#input_modal').find('#id_desawisata'),
    'id_data_desawisata': $('#input_modal').find('#id_data_desawisata'),
  ...
  InputModal.id_desawisata.val(id_desawisata);
  ...
  var EditModal = {
    ...
    'edit_id_desawisata': $('#edit_modal').find('#edit_id_desawisata'),
    'id_data_desawisata': $('#edit_modal').find('#id_data_desawisata'),
...
function ApprovProfil() {
    swal(swalApprovConfigure).then((result) => {
      ...
      $.ajax({
        url: `<?=site_url('DetailDesawisataController/approvDesawisata')?>`, 'type': 'get',
        data: {id_desawisata : id_desawisata} ,
        success: function (data){
        getProfil();
        },
        error: function(e) {}
  ...
  function getProfil(){
    $.ajax({
      url: `<?=site_url('DetailDesawisataController/getProfil')?>`, 'type': 'GET',
      data: {id_desawisata : id_desawisata},
      success: function (data){
        var json = JSON.parse(data);
        dataProfil = json['data'];
        initMap();
        var nama = document.getElementById("namadesawisata");
        ...
        var id_upload1 = document.getElementById("id_desawisatatoupload1");
        var id_upload2 = document.getElementById("id_desawisatatoupload2");
      ...
      //  var edit_profil_btn = document.getElementById("edit_profil_btn");
        ...
        id_upload4.value = id_desawisata;
        nama.value = dataProfil['nama'];
        alamat.value = dataProfil['alamat'];
        
        
        kategori.value = dataProfil['nama_kategori'];
  ...
  function delPhoto(photo){
    swal(swalDelPhoto).then((result) => {
      if(!result.value){ return; }
      $.ajax({
        url: `<?=site_url('DetailDesawisataController/delPhoto')?>`, 'type': 'POST',
        data: {id_desawisata : id_desawisata, hapus : photo, file2 : dataProfil['file2']} ,
        success: function (data){
        getProfil();
          //var dataPengunjung = json['data']
          //dataDetailDesawisata[detaildesawisata['nomor']] = detaildesawisata;
          
         // getInputPengunjung();
          // DetailDesawisataModal.self.modal('hide');
        },
        error: function(e) {}
      });
    });
    ...
    function getUserApprov(id_user){    
      $.ajax({
        url: `<?=site_url('DetailDesawisataController/getUser')?>`, 'type': 'GET',
  ...
  function getDetailDesawisata(){
    buttonLoading(toolbar.showBtn);
    console.log(toolbar.form.serialize());
    $.ajax({
      url: `<?=site_url('DetailDesawisataController/getAllDetailDesawisata')?>`, 'type': 'GET',
      data: {id_desawisata : id_desawisata},
      success: function (data){
        ...
        dataDetailDesawisata = json['data'];
        renderDetailDesawisata(dataDetailDesawisata);
      },
      error: function(e) {}
    });
  ...
  function getInputPengunjung(){
    ...
    $.ajax({
      url: `<?=site_url('DetailDesawisataController/getAllDetailDesawisata')?>`, 'type': 'GET',
      data: {id_desawisata : id_desawisata, tahun: InputModal.tahun.val() },
      success: function (data){
        //buttonIdle(toolbar.showBtn);
        var json = JSON.parse(data);
        if(json['error']){
...
function renderInputPengunjung(data){
  ...
  function approvInputPengunjung(){
    swal(swalSaveConfigure).then((result) => {
      ...
      $.ajax({
        url: `<?=site_url('DetailDesawisataController/approvPengunjung')?>`, 'type': 'POST',
  ...
  function saveInputPengunjung(){
    swal(swalSaveConfigure).then((result) => {
      ...
      buttonLoading(InputModal.save_pengunjung);
      $.ajax({
        url: `<?=site_url('DetailDesawisataController/savePengunjung')?>`, 'type': 'POST',
        data: InputModal.form.serialize(),
        success: function (data){
          buttonIdle(InputModal.save_pengunjung);
          var json = JSON.parse(data);
  ...
  function renderDetailDesawisata(data){
    if(data == null || typeof data != "object"){
      console.log("User::UNKNOWN DATA");
      return;
    }
    ...
    var renderData = [];
    Object.values(data).forEach((detaildesawisata) => {
      renderData.push([detaildesawisata['nomor'], detaildesawisata['tahun'],detaildesawisata['nama_bulan'],detaildesawisata['domestik'], detaildesawisata['mancanegara'],detaildesawisata['jumlah']]);
    });
  ...
  EditModal.form.submit(function(event){
    ...
    switch(EditModal.form[0].target){
      case 'edit':
        editDetailDesawisata();
        break;
    }
  });


  function editDetailDesawisata(){
    swal(swalSaveConfigure).then((result) => {
      if(!result.value){ return; }
      buttonLoading(EditModal.saveEditBtn);
      $.ajax({
        url: `<?=site_url('DetailDesawisataController/editDetailDesawisata')?>`, 'type': 'POST',
        ...
        success: function (data){
          ...
          var detaildesawisata = json['data']
          console.log(detaildesawisata);
          getProfil();
          swal("Simpan Berhasil", "", "success");
         // renderDetailDesawisata(dataDetailDesawisata);
  ...
  function renderKategoriSelection(data){
    EditModal.edit_id_kategori.empty();
    EditModal.edit_id_kategori.append($('<option>', { value: "", text: "-- Pilih Kategori --"}));
    Object.values(data).forEach((d) => {
      EditModal.edit_id_kategori.append($('<option>', {
        value: d['id_kategori'],
