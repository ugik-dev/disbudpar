...
$(document).ready(function() {
  ...
  var BiroModal = {
    ...
    'kabupaten': $('#biro_modal').find('#kabupaten'),
  }
  ...
  function renderBiro(data){
    ...
    Object.values(data).forEach((biro) => {
      ...
      `;
      renderData.push([biro['nama'],biro['nama_jenis_biro'],biro['nama_sertifikat_biro'],biro['nama_kabupaten'],apprv, button]);
    });
  ...
  FDataTable.on('click','.edit', function(){
    ...
    BiroModal.kabupaten.val(biro['id_kabupaten']);
  });
  ...
  function renderKabupatenSelection(data){
    BiroModal.kabupaten.empty();
    BiroModal.kabupaten.append($('<option>', { value: "", text: "-- Pilih Kabupaten --"}));
    Object.values(data).forEach((d) => {
      BiroModal.kabupaten.append($('<option>', {
