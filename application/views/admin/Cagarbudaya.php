...
$(document).ready(function() {
  ...
  var CagarbudayaModal = {
    ...
    'kabupaten': $('#cagarbudaya_modal').find('#kabupaten'),
  ...
  function renderKabupatenSelection(data){
    CagarbudayaModal.kabupaten.empty();
    CagarbudayaModal.kabupaten.append($('<option>', { value: "", text: "-- Pilih Kabupaten --"}));
    Object.values(data).forEach((d) => {
      CagarbudayaModal.kabupaten.append($('<option>', {
  ...
  function renderCagarbudaya(data){
    ...
    Object.values(data).forEach((cagarbudaya) => {
      ...
      var detailButton =`
      <a class="detail dropdown-item" href='<?=site_url()?>AdminController/DetailCagarbudaya?id_cagarbudaya=${cagarbudaya['id_cagarbudaya']}'><i class='fa fa-share'></i> Detail Cagarbudaya</a>
      `;  
      var editButton = `
      ...
      `;
      renderData.push([cagarbudaya['nama'], cagarbudaya['nama_jenis_cagarbudaya'], cagarbudaya['nama_kabupaten'], cagarbudaya['nama_kepemilikan_cagarbudaya'], cagarbudaya['nama_status_penetapan_cagarbudaya'],apprv, button]);
    });
  ...
  FDataTable.on('click','.edit', function(){
    ...
    CagarbudayaModal.kabupaten.val(cagarbudaya['id_kabupaten']);
  });
