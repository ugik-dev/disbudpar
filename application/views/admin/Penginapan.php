...
$(document).ready(function() {
  ...
  var PenginapanModal = {
    ...
    'kabupaten': $('#penginapan_modal').find('#kabupaten'),
  }
  ...
  function renderKabupatenSelection(data){
    PenginapanModal.kabupaten.empty();
    PenginapanModal.kabupaten.append($('<option>', { value: "", text: "-- Pilih Kabupaten --"}));
    Object.values(data).forEach((d) => {
      PenginapanModal.kabupaten.append($('<option>', {
  ...
  function renderPenginapan(data){
    ...
    Object.values(data).forEach((penginapan) => {
      ...
      var detailButton =`
      <a class="detail dropdown-item" href='<?=site_url()?>AdminController/DetailPenginapan?id_penginapan=${penginapan['id_penginapan']}'><i class='fa fa-share'></i> Detail Penginapan</a>
      `; 
      var editButton = `
      ...
      `;
      renderData.push([penginapan['nama'],penginapan['nama_jenis_penginapan'],penginapan['tahun_terdata'],penginapan['nama_kabupaten'],apprv, button]);
    });
