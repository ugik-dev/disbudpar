      ...
      <div class="modal-body" id="modal-body">              
        <form role="form" id="user_form" onsubmit="return false;" type="multipart" autocomplete="off">
          ...
          <div class="form-group">
            ...
            <input type="text" placeholder="Nama Daya Tarik Wisata" class="form-control" id="edit_nama" name="nama" required="required">
          </div>
          <div class="form-group">
...
document.getElementById("export_btn").href = '<?= site_url('AdminController/PdfObjek?id_objek=')?>'+id_objek;
var Photo2Modal = {
    'self': $('#photo2_modal'),
...
function renderPhotoModal(){
 ...
 // tmp2 =`active`;
  ...
  function MessageFunction() {
    ...
    formatMessage = `Pada Daya Tarik Wisata - `+dataProfil['nama']+`
`;
...
function renderInputPengunjung(data){
    ...
    document.getElementById("export_pengunjung_btn").href = '<?= site_url('AdminController/ExportPengunjung?tb=objek&id_data=')?>'+id_objek+`&tahun=`+InputModal.tahun.val();
    var i = 1;
    var tmpdl = 0;
    var tmpdp = 0;
    var tmpml = 0;
