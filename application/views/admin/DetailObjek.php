                    ...
                    <div class="row">
                        ...
                        <div class="ibox">
                            ...
                            <div id="profil">
                                ...
                                <div class="form-group">
                                    <label for="formGroupExampleInput">Nama Daya Tarik Wisata</label>
                                ...
                                <div class="form-row">
                                    ...
                                    <label for="formGroupExampleInput">Jenis Daya Tarik Wisata</label>
                                ...
                                <button class="btn btn-success my-1 mr-sm-2" type="submit" id="edit_profil_btn" onclick="myFunction()" data-loading-text="Loading..."><strong>Ubah Data Daya Tarik Wisata</strong></button>
                                <button class="btn btn-info my-1 mr-sm-2" type="submit" id="approv_profil_btn" onclick="ApprovProfil()" data-loading-text="Loading..."><strong>Approv Profil Daya Tarik Wisata</strong></button>
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group" style="width : 60%;">
                                            ...
                                            <input type="text" class="form-control" id="id_objektoupload1" name="id_objek" hidden>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group" style="width : 60%;">
                                            ...
                                            <input type="text" class="form-control" id="id_objektoupload2" name="id_objek" hidden >
                                ...
                                <div class="form-row">
                                    <form class="form-row col-md-12" id="form_uploaddokumen" onsubmit="return false;">
                                        ...
                                        <div class="form-group" style="width : 60%;">
                                                <input type="text" class="form-control" id="id_objektoupload4" name="id_objek" hidden>
    ...
    <div class="modal-content animated fadeIn">
      ...
      <div class="modal-body" id="modal-body">              
        <form role="form" id="user_form" onsubmit="return false;" type="multipart" autocomplete="off">
          <input type="text" id="edit_id_objek" name="id_objek" hidden>
          <div class="form-group">
            <label for="nama">Nama Daya Tarik Wisata</label> 
            <input type="text" placeholder="Nama Objek" class="form-control" id="edit_nama" name="nama" required="required">
          </div>
          <div class="form-group">
            <label for="jenis">Jenis Daya Tarik Wisata</label> 
            <select class="form-control mr-sm-2" id="edit_id_jenis" name="id_jenis" required="required">
            </select>
          </div>
...
function ApprovProfil() {
    swal(swalApprovConfigure).then((result) => {
      ...
      $.ajax({
        url: `<?=site_url('DetailObjekController/approvObjek')?>`, 'type': 'get',
  ...
  function getProfil(){
    $.ajax({
      ...
      success: function (data){
        ...
        var id_upload1 = document.getElementById("id_objektoupload1");
  ...
  function delPhoto(photo){
    swal(swalDelPhoto).then((result) => {
      if(!result.value){ return; }
      $.ajax({
        url: `<?=site_url('DetailObjekController/delPhoto')?>`, 'type': 'POST',
        data: {id_objek : id_objek, hapus : photo, file2 : dataProfil['file2']} ,
        success: function (data){
        getProfil();
...
function renderInputPengunjung(data){
  ...
  function approvInputPengunjung(){
    swal(swalSaveConfigure).then((result) => {
      ...
      $.ajax({
        url: `<?=site_url('DetailObjekController/approvPengunjung')?>`, 'type': 'POST',
