...
$(document).ready(function() {
  ...
  function getKelolahuser(){
    ...
    $.ajax({
      url: `<?=site_url('KelolahuserController/getAllKelolahuser')?>`, 'type': 'GET',
      data: {},
      success: function (data){
  ...
  function renderKelolahuser(data){
    ...
    Object.values(data).forEach((user) => {
      ...
      `;
      renderData.push([user['username'],user['nama'], user['nama_role'], user['nama_kabupaten'], button]);
    });
  ...
  FDataTable.on('click','.edit', function(){
    ...
    if(KelolahuserModal.id_role.val()=='1'){
        KelolahuserModal.kabupaten.prop('disabled',true);   
    }else{
        KelolahuserModal.kabupaten.prop('disabled',false); 
        KelolahuserModal.kabupaten.val(user['id_kabupaten']);  
    }
  ...
  function renderKabupatenSelection(data){
    KelolahuserModal.kabupaten.empty();
    KelolahuserModal.kabupaten.append($('<option>', { value: "", text: "-- Pilih Kabupaten --"}));
    Object.values(data).forEach((d) => {
      KelolahuserModal.kabupaten.append($('<option>', {
