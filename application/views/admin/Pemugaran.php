            ...
            <table id="FDataTable" class="table table-bordered table-hover" style="padding:0px">
              <thead>
                <tr>
                  ...
                  <th style="width: 12%; text-align:center!important">Kabupaten</th>
...
$(document).ready(function() {
  ...
  var PemugaranModal = {
    ...
    'id_kabupate': $('#pemugaran_modal').find('#id_kabupaten'),
  ...
  function renderPemugaran(data){
    ...
    Object.values(data).forEach((pemugaran) => {
      ...
      var detailButton =`
      <a class="detail dropdown-item" href='<?=site_url()?>AdminController/DetailPemugaran?id_pemugaran=${pemugaran['id_pemugaran']}'><i class='fa fa-share'></i> Detail </a>
      `; 
      var editButton = `
      ...
      `;
      renderData.push([ pemugaran['nama'], pemugaran['nama_cagarbudaya'],pemugaran['nama_kabupaten'],pemugaran['tanggal_kegiatan'],apprv, button]);
    });
