        ...
        <div id="profil">
            <form>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="namakabupaten"  readonly="readonly">
              </div>
            ...
            <button hidden class="btn btn-info my-1 mr-sm-2" type="submit" id="approv_profil_btn" onclick="ApprovProfil()" data-loading-text="Loading..."><strong>Approv Data</strong></button>
        ...
        <div class="ibox-content">
              ...
              <form class="form-row col-md-12" id="form_upload1" onsubmit="return false;" >
                  <div class="form-group" style="width : 60%;">
                       <input type="text" class="form-control" id="file" name="fileold" hidden>
                          <input type="text" class="form-control" id="id_pemugarantoupload1" name="id_pemugaran" hidden>
                ...
                <form class="form-row col-md-12" id="form_upload2" onsubmit="return false;" >
                  <div class="form-group" style="width : 60%;">
                   <input type="text" id="file2" name="fileold" hidden>
                        <input type="text" class="form-control" id="id_pemugarantoupload2" name="id_pemugaran" hidden >
              ...
              <!-- </div> -->
               ...
               <div class="form-row">
                ...
                <div class="form-group"  style="width : 60%;">
                        <input type="text" class="form-control" id="id_pemugarantoupload4" name="id_pemugaran" hidden>
    ...
    <div class="modal-content animated fadeIn">
      ...
      <div class="modal-body" id="modal-body">              
        <form role="form" id="user_form" onsubmit="return false;" type="multipart" autocomplete="off">
          <input type="text" id="edit_id_pemugaran" name="id_pemugaran" hidden>
          <div class="form-group">
            <label for="nama">Nama Pemugaran</label> 
            <input type="text" placeholder="Nama Pemugaran" class="form-control" id="edit_nama" name="nama" required="required">
          </div>
          
          <div class="form-group">
            <label for="j">Cagar Budaya </label> 
            <select class="form-control mr-sm-2" id="edit_id_cagarbudaya" name="id_cagarbudaya" required="required">
            </select>
          </div>
...
document.getElementById("export_btn").href = '<?= site_url('AdminController/Pdfpemugaran?id_pemugaran=')?>'+id_pemugaran;
var Photo2Modal = {
    'self': $('#photo2_modal'),
...
function ApprovProfil() {
    swal(swalApprovConfigure).then((result) => {
      ...
      $.ajax({
        url: `<?=site_url('DetailPemugaranController/approvPemugaran')?>`, 'type': 'get',
...
//======
  ...
  // EditModal.edit_id_pemugaran.val(id_pemugaran);
...
function myFunction() {
  console.log('cok');
    ...
    EditModal.edit_id_cagarbudaya.val(dataProfil['id_cagarbudaya']);
  ...
  function getProfil(){
    $.ajax({
      ...
      success: function (data){
        ...
        var namakabupaten = document.getElementById("namakabupaten");
        ...
        var id_upload1 = document.getElementById("id_pemugarantoupload1");
        var id_upload2 = document.getElementById("id_pemugarantoupload2");
        
        var id_upload4 = document.getElementById("id_pemugarantoupload4");
        var nama_user_entry = document.getElementById("nama_user_entry");
      //  var edit_profil_btn = document.getElementById("edit_profil_btn");
        
        id_upload1.value = id_pemugaran;
        id_upload2.value = id_pemugaran;
     
        id_upload4.value = id_pemugaran;
        nama.value = dataProfil['nama'];
        namakabupaten.value = dataProfil['nama_kabupaten'];
...
function renderInputPengunjung(data){
  ...
  function delPhoto(photo){
    swal(swalDelPhoto).then((result) => {
      if(!result.value){ return; }
      $.ajax({
        url: `<?=site_url('DetailPemugaranController/delPhoto')?>`, 'type': 'POST',
        data: {id_pemugaran : id_pemugaran, hapus : photo, file2 : dataProfil['file2']} ,
        success: function (data){
        getProfil();
          //var dataPengunjung = json['data']
          //dataDetailPemugaran[detailpemugaran['nomor']] = detailpemugaran;
