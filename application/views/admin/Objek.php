...
$(document).ready(function() {
  ...
  var ObjekModal = {
    ...
    'kabupaten': $('#objek_modal').find('#kabupaten'),
  }
  ...
  function renderObjek(data){
    ...
    Object.values(data).forEach((objek) => {
      ...
      `;
      renderData.push([objek['nama'], objek['nama_jenis_objek'],objek['tahun_terdata'] ,objek['nama_kabupaten'],apprv, button]);
    });
  ...
  FDataTable.on('click','.edit', function(){
    ...
    ObjekModal.kabupaten.val(objek['id_kabupaten']);
  });
  ...
  function renderKabupatenSelection(data){
    ObjekModal.kabupaten.empty();
    ObjekModal.kabupaten.append($('<option>', { value: "", text: "-- Pilih Kabupaten --"}));
    Object.values(data).forEach((d) => {
      ObjekModal.kabupaten.append($('<option>', {
