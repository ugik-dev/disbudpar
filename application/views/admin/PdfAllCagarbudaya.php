...
// Membuat string
$pdf->Cell(195,7,'DATA CAGAR BUDAYA',0,1,'C');
$pdf->Cell(10,7,' ',0,1);

// Setting spasi kebawah supaya tidak rapat
$pdf->Cell(50,7,'Nama Cagar',1,0);
$pdf->Cell(50,7,'Jenis',1,0); 
$pdf->Cell(50,7,'Kepemilikan',1,0); 
$pdf->Cell(50,7,'Status Penetapan',1,0); 
$pdf->Cell(70,7,'Alamat',1,1); 
$pdf->SetFont('Arial','',10);
foreach ($data as $key => $value){

$pdf->Cell(50,7,$value['nama'],1,0);
$pdf->Cell(50,7,$value['nama_jenis_cagarbudaya'],1,0); 
$pdf->Cell(50,7,$value['nama_kepemilikan_cagarbudaya'],1,0); 
$pdf->Cell(50,7,$value['nama_status_penetapan_cagarbudaya'],1,0); 
