...
// Membuat string
$pdf->Cell(195,7,'DATA Pemugaran',0,1,'C');
$pdf->Cell(10,7,' ',0,1);

// Setting spasi kebawah supaya tidak rapat
$pdf->Cell(70,7,'Nama',1,0);
$pdf->Cell(50,7,'Tanggal Kegiatan',1,0);
$pdf->Cell(70,7,'Cagar Yang di Pugar',1,0); 
$pdf->Cell(40,7,'Kabupaten',1,1); 

$pdf->SetFont('Arial','',10);
foreach ($data as $key => $value){

$pdf->Cell(70,7,$value['nama'],1,0);
$pdf->Cell(50,7,$value['tanggal_kegiatan'],1,0);
$pdf->Cell(70,7,$value['nama_cagarbudaya'],1,0);  
$pdf->Cell(40,7,$value['nama_kabupaten'],1,1); 
