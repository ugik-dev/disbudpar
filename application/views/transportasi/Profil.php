      ...
      <div class="ibox">
        ...
        <div id="profil">
            <form>
              ...
              <div class="form-group">
                <label for="formGroupExampleInput">Nama Transportasi</label>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content animated fadeIn">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Kelola Transportasi</h4>
...
// document.getElementById("export_btn").href = '<?= site_url('OperatorController/PdfTransportasi?id_transportasi=')?>'+id_transportasi;
var Photo2Modal = {
    'self': $('#photo2_modal'),
...
//     formatMessage = `Pada Transportasi - `+dataProfil['nama']+`
// `;
  ...
  function getProfil(){
    $.ajax({
      ...
      success: function (data){
        ...
        if(dataProfil['id_operator']=='0'){
          nama_user_entry.value = "Tidak Terdeteksi"
        }else{
          nama_user_entry.value = getUserEntry(dataProfil['id_operator']);
        };
...
function ApprovProfil() {
  ...
  //         </div>
  //         <div class="col">
  //         <label>Lama Transportasi Domestik (Hari)</label>
  //         </div>
  //         <div class="col">
  //         <label>Lama Transportasi Mancanegara (Hari) </label>
  //         </div>
  //         <div class="col">
  //         <label>Total Lama Transportasi (Hari) </label>
  //         </div>
  ...
  //         </div>
  //         <div class="col">  
  //           <input type="number" class="form-control" name="domestik_personal_l${i}" placeholder="" value="${d['domestik_personal_l']}">
  //         </div>
  //         <div class="col">
  //           <input type="number" class="form-control" name="domestik_personal_p${i}" placeholder="" value="${d['domestik_personal_p']}">
  //         </div>
  //         <div class="col">
  //           <input type="number" class="form-control" name="mancanegara_personal_l${i}" placeholder="" value="${d['mancanegara_personal_l']}">
  //         </div>
  //         <div class="col">
  //           <input type="number" class="form-control" name="mancanegara_personal_p${i}" placeholder=""  value="${d['mancanegara_personal_p']}">
  //         </div>
  //         <div class="col">
  //           <input type="number" class="form-control" placeholder="0"  value="${d['jumlah_personal']}" disabled>
  //         </div>
  //         <div class="col">
  //           <input type="number" class="form-control" name="domestik_durasi${i}" placeholder="" value="${d['domestik_durasi']}">
  //         </div>
  //         <div class="col">
  //           <input type="number" class="form-control" name="mancanegara_durasi${i}" placeholder=""  value="${d['mancanegara_durasi']}">
  //         </div>
  //         <div class="col">
