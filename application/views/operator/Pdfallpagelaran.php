...
// Membuat string
$pdf->Cell(195,7,'DATA Pagelaran / Event',0,1,'C');
$pdf->Cell(10,7,' ',0,1);

// Setting spasi kebawah supaya tidak rapat
$pdf->Cell(50,7,'Nama',1,0);
$pdf->Cell(30,7,'Jenis',1,0);
$pdf->Cell(50,7,'Pelaksana',1,0); 
$pdf->Cell(32,7,'Kabupaten',1,0); 
$pdf->Cell(40,7,'Kordinat',1,0); 
$pdf->Cell(50,7,'Alamat',1,1); 
$pdf->SetFont('Arial','',10);
foreach ($data as $key => $value){

$pdf->Cell(50,7,$value['nama'],1,0);
$pdf->Cell(30,7,$value['nama_jenis_pagelaran'],1,0);
$pdf->Cell(50,7,$value['nama_senibudaya'],1,0);  
$pdf->Cell(32,7,$value['nama_kabupaten'],1,0); 
$pdf->Cell(40,7,$value['lokasi'],1,0); 
$pdf->Cell(50,7,$value['alamat'],1,1); 
