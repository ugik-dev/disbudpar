    ...
    <div class="modal-content animated fadeIn">
      ...
      <div class="modal-body" id="modal-body">              
        <form role="form" id="user_form" onsubmit="return false;" type="multipart" autocomplete="off">
          ...
          <div class="form-group">
            <label for="edit_jumlah_kamar">Jumlah Tempat Kamar</label> 
...
document.getElementById("export_btn").href = '<?= site_url('OperatorController/PdfPenginapan?id_penginapan=')?>'+id_penginapan;
var Photo2Modal = {
    'self': $('#photo2_modal'),
