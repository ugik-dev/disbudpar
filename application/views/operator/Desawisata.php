...
$(document).ready(function() {
  ...
  document.getElementById("export_btn").href = '<?= site_url('OperatorController/PdfAllDesawisata')?>';
  ...
  function renderDesawisata(data){
    ...
    Object.values(data).forEach((desawisata) => {
      ...
      var detailButton =`
      <a class="detail dropdown-item" href='<?=site_url()?>OperatorController/DetailDesawisata?id_desawisata=${desawisata['id_desawisata']}&nama_desawisata=${desawisata['nama']}'><i class='fa fa-share'></i> Detail Desa Wisata</a>
      `; 
      var editButton = `
