...
document.getElementById("export_btn").href = '<?= site_url('OperatorController/PdfDesawisata?id_desawisata=')?>'+id_desawisata;
...
//   }
  ...
  function getInputPengunjung(){
    ...
    document.getElementById("export_pengunjung_btn").href = '<?= site_url('OperatorController/ExportPengunjung?tb=desawisata&id_data=')?>'+id_desawisata+`&tahun=`+InputModal.tahun.val();
