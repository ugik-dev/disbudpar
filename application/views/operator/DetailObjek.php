    ...
    <div class="col-lg-6">
      <div class="ibox">
        ...
        <div id="profil">
            ...
            <button class="btn btn-success my-1 mr-sm-2" type="submit" id="edit_profil_btn" onclick="myFunction()" data-loading-text="Loading..."><strong>Ubah Data Objek Wisata</strong></button>
          </div><!-- profil -->
          </div><!-- ibox content -->
      </div> <!-- ibox -->
      <div class="ibox">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content animated fadeIn">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Kelola Objek Wisata</h4>
      ...
      <div class="modal-body" id="modal-body">              
        <form role="form" id="user_form" onsubmit="return false;" type="multipart" autocomplete="off">
          ...
          <div class="form-group">
            <label for="jenis">Jenis Objek Wisata</label> 
            <select class="form-control mr-sm-2" id="edit_id_jenis" name="id_jenis_objek" required="required">
            </select>
          </div>
