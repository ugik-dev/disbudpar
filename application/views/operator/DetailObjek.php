...
document.getElementById("export_btn").href = '<?= site_url('OperatorController/PdfObjek?id_objek=')?>'+id_objek;
var Photo2Modal = {
    'self': $('#photo2_modal'),
...
function myFunction() {
  ...
  function getInputPengunjung(){
    document.getElementById("export_pengunjung_btn").href = '<?= site_url('OperatorController/ExportPengunjung?tb=objek&id_data=')?>'+id_objek+`&tahun=`+InputModal.tahun.val();
    console.log(toolbar.form.serialize());
    $.ajax({
      url: `<?=site_url('DetailObjekController/getAllDetailObjek')?>`, 'type': 'GET',
