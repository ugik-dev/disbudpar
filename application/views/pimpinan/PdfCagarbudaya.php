...
$pdf->Cell(10,7,'',0,1);
$pdf->Cell(50,7,'Jenis Cagar Budaya',0,0); 
$pdf->Cell(10,7,' : '.$dataProfil['nama_jenis_cagarbudaya'],0,1); 
$pdf->Cell(50,7,'Kepemilikan',0,0); 
$pdf->Cell(10,7,' : '.$dataProfil['nama_kepemilikan_cagarbudaya'],0,1); 
$pdf->Cell(50,7,'Status Penetapan',0,0); 
//$lok = explode(',',$dataProfil['lokasi']);
$pdf->Cell(10,7,' : '.$dataProfil['nama_status_penetapan_cagarbudaya'],0,1); 
$pdf->Cell(50,7,'Kabupaten',0,0); 
$pdf->Cell(10,7,' : '.$kabupaten,0,1);
