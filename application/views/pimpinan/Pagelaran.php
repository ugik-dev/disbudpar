...
$(document).ready(function() {
  ...
  document.getElementById("export_btn").href = '<?= site_url('PimpinanController/PdfAllPagelaran')?>';
  ...
  function renderPagelaran(data){
    ...
    Object.values(data).forEach((pagelaran) => {
      ...
      `; 
      var editButton = `
        <a hidden class="edit dropdown-item" data-id='${pagelaran['id_pagelaran']}'><i class='fa fa-pencil'></i> Edit Seni Budaya</a>
      `;
      var deleteButton = `
        <a hidden class="delete dropdown-item" data-id='${pagelaran['id_pagelaran']}'><i class='fa fa-trash'></i> Hapus Seni Budaya</a>
      `;
      var button = `
