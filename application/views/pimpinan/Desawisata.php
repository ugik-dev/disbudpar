...
$(document).ready(function() {
  ...
  document.getElementById("export_btn").href = '<?= site_url('PimpinanController/PdfAllDesawisata')?>';
  ...
  function renderDesawisata(data){
    ...
    Object.values(data).forEach((desawisata) => {
      ...
      var detailButton =`
      <a class="detail dropdown-item" href='<?=site_url()?>PimpinanController/DetailDesawisata?id_desawisata=${desawisata['id_desawisata']}&nama_desawisata=${desawisata['nama']}'><i class='fa fa-share'></i> Detail Desa Wisata</a>
      `; 
      var editButton = `
        <a hidden class="edit dropdown-item" data-id='${desawisata['id_desawisata']}'><i class='fa fa-pencil'></i> Edit Desawisata</a>
      `;
      var deleteButton = `
        <a hidden class="delete dropdown-item" data-id='${desawisata['id_desawisata']}'><i class='fa fa-trash'></i> Hapus Desawisata</a>
      `;
      var button = `
      ...
      `;
      renderData.push([desawisata['nama'], desawisata['nama_kategori'],apprv, button]);
    });
