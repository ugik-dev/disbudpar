...
//======
  ...
  var MessageModal = {
    ...
    'addBtn': $('#message_modal').find('#add_btn'),
    'saveEditBtn': $('#message_modal').find('#save_edit_btn'),
    'edit_id_pagelaran': $('#message_modal').find('#edit_id_pagelaran'),
    'id_data_pagelaran': $('#message_modal').find('#id_data_pagelaran'),
    'edit_nama': $('#message_modal').find('#edit_nama'),
    'edit_alamat': $('#message_modal').find('#edit_alamat'),
    'edit_jumlah_penonton': $('#message_modal').find('#edit_jumlah_penonton'),
    'edit_lokasi': $('#message_modal').find('#edit_lokasi'),
    'edit_deskripsi': $('#message_modal').find('#edit_deskripsi'),
    'edit_id_jenis': $('#message_modal').find('#edit_id_jenis'),
    'edit_id_senibudaya': $('#message_modal').find('#edit_id_senibudaya'),
    'edit_tanggal_kegiatan': $('#message_modal').find('#edit_tanggal_kegiatan'),
    'edit_tanggal_kegiatan_end': $('#message_modal').find('#edit_tanggal_kegiatan_end'),
...
function ApprovFunction() {
  ...
  swal(swalSaveConfigure).then((result) => {
      ...
      $.ajax({
        ...
        data: {id_pagelaran: dataProfil['id_pagelaran']},
 ...
 var MessageModal = {
  ...
  function MessageFunction() {
    ...
    formatMessage = `Pada Pagelaran dan Pameran - `+dataProfil['nama']+`
`;
...
MessageModal.form.trigger('reset'); 
  ...
  function getProfil(){
    $.ajax({
      ...
      //  var approv_btn = document.getElementById("approv_btn");
...
/* ApprovFunction toggles between adding and removing the show class, which is used to hide and show the dropdown content */
