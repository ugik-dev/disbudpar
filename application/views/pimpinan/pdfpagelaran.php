...
$pdf->Cell(10,7,'',0,1);
$pdf->Cell(50,7,'Kategori Desawisata',0,0); 
$pdf->Cell(10,7,' : '.$dataProfil['nama_jenis_pagelaran'],0,1); 
$pdf->Cell(50,7,'Kordinat Lokasi',0,0); 
$pdf->Cell(10,7,' : '.$dataProfil['lokasi'],0,1);  
$pdf->Cell(50,7,'Jumlah Penonton',0,0); 
$pdf->Cell(10,7,' : '.$dataProfil['jumlah_penonton'],0,1);  
