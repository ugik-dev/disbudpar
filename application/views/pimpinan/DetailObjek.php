...
document.getElementById("export_btn").href = '<?= site_url('PimpinanController/PdfObjek?id_objek=')?>'+id_objek;
var Photo2Modal = {
    'self': $('#photo2_modal'),
...
function ApprovProfil() {
  ...
  function getInputPengunjung(){
    document.getElementById("export_pengunjung_btn").href = '<?= site_url('PimpinanController/ExportPengunjung?tb=objek&id_data=')?>'+id_objek+`&tahun=`+InputModal.tahun.val();
