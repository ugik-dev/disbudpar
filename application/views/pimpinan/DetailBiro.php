...
document.getElementById("export_btn").href = '<?= site_url('PimpinanController/PdfBiro?id_biro=')?>'+id_biro;
var Photo2Modal = {
    'self': $('#photo2_modal'),
...
document.getElementById("export_pengunjung_btn").href = '<?= site_url('PimpinanController/ExportPengunjung?tb=biro&id_data=')?>'+id_biro+`&tahun=`+InputModal.tahun.val();
    var i = 1;
    var tmpdl = 0;
    var tmpdp = 0;
    var tmpml = 0;
