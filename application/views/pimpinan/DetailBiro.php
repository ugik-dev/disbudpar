...
$(document).ready(function() {
  ...
  var MessageModal = {
    ...
    'edit_id_biro': $('#message_modal').find('#edit_id_biro'),
    'id_data_biro': $('#message_modal').find('#id_data_biro'),
...
function ApprovFunction() {
  ...
  swal(swalSaveConfigure).then((result) => {
      ...
      $.ajax({
        url: `<?=site_url('DetailBiroController/approv')?>`, 'type': 'GET',
        data: {id_biro: dataProfil['id_biro']},
        success: function (data){
