  ...
  public function getAllKelolahuser($filter = []){
	...
	public function getKelolahuser($idKelolahuser = NULL){
	  ...
	  public function addKelolahuser($data){
	    ...
	    $dataInsert = DataStructure::slice($data, ['password','username','nama','id_kabupaten','id_role','id_kabupaten']);
	...
	public function editKelolahuser($data){
			$this->db->set(DataStructure::slice($data, ['username','nama','id_role','id_kabupaten']));				
